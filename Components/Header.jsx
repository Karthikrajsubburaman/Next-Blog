  ...
  return (
    <div className='py-5 px-5 md:px-12 lg:px-28'>
      ...
      <div className='text-center my-8'>
        ...
        <p className='mt-10 max-w-[740px] m-auto text-xs sm:text-base'>A new JavaScript framework, Qwik, has been gaining attention for its unique approach to building web applications.</p>
        <form action='' className='flex justify-between max-w-[500px] scale-75 sm:scale-100 mx-auto mt-10 border border-black shadow-[-7px_7px_0px_#000000]'>
          <input type='email' placeholder='Enter your email' className='pl-10 outline-none '/>
