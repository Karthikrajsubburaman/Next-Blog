  ...
  return ( data?<>
    <div className='bg-gray-200 py-5 px-5 md:px-12 lg:px-28 '>
      ...
      <div className='mx-5 max-w-[800px] md:mx-auto mt-[-100px] mb-10'>
        ...
        <p className='my-3'>Before you can manage your lifestyle, you must have a clear of what you want to achieve. Start by reflection on your values, aspirations, and long-term goals.</p>
        <p className='my-3'>Before you can manage your lifestyle, you must have a clear of what you want to achieve. Start by reflection on your values, aspirations, and long-term goals.</p>
